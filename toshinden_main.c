...
int toshinden_main(int argc, char* argv[]) {
    ...
    GBConfig runtime_config = *toshinden_default_config();
    ...
    if (differential_mode) {
        ...
        gb_context_set_save_id(generated_ctx, "toshinden");
        gb_context_set_save_id(interpreted_ctx, "toshinden");
        if (serial_stdout) {
            generated_ctx->callbacks.on_serial_byte = gbrt_serial_stdout;
        }
        toshinden_init(generated_ctx, rom_data, rom_size);
        toshinden_init(interpreted_ctx, rom_data, rom_size);
        if (data_mod_file) {
    ...
    gb_context_set_save_id(ctx, "toshinden");
    ...
    toshinden_init(ctx, rom_data, rom_size);
    if (data_mod_file) {
    ...
    const GBPortMetadata port_metadata = {
        ...
        .game_id = "toshinden",
        .game_title = "toshinden",
        .rom_sha256 = "519ca6523e54b67a4b4dcc7f525d56df986e0d77c84699dcf9e022f0ae6fbd0e",
        .rom_size = 524288u,
    };
...
int main(int argc, char* argv[]) {
    return toshinden_main(argc, argv);
}
